	...
	<div class="slider fullscreen content-block_st">
						...
						<div class="col s6 m6">
							<div class="card-panel blue-grey darken-1">
								<h5>
									...
									<span class="white-text thin">
									Welcome to Moon Stone. We are proud to say that we have over 10 years 
									within the industry, supplying, designing and installing some of the finest 
									stonework in the country.
									</span>
       ...
       -->
						...
						<div class="col s6 offset-s6">
							<div class="card-panel blue-grey darken-1  ">
								<h5>
									...
									we provide complete professionalism. 
									Our team are not only the most experienced but also the most trustworthy and reliable on hand. </span>
								</h5>
							</div>
						</div>
					</div>
						...
						<div class="col s6 s6">
							<div class="card-panel blue-grey darken-1  ">
								<h5>
									...
									we will spend time providing you with interpretations of the final construction, 
									allowing you to fully visualise the outcome. 
									</span>
								</h5>
        ...
        -->
						...
						<div class="col s6 offset-s6">
							<div class="card-panel blue-grey darken-1  ">
								<h5>
									...
									all the way through to installation of the best natural stone designs. </span>
								</h5>
							</div>
						</div>
					</div>
			...
			<li>
				 <div id="portada7"></div> 
				<!-- <img src="img/img_header/picJumbo/smartphone-431230_1920_left.jpg"> -->
